...
import com.chridam.blackout.database.LocationDatabaseHelper;
...
public class LocationsContentProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        // Set the table
        queryBuilder.setTables(LocationsTable.TABLE_LOCATION);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriType) {
            case TODOS:
                id = sqlDB.insert(LocationsTable.TABLE_LOCATION, null, values);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case TODOS:
                rowsDeleted = sqlDB.delete(LocationsTable.TABLE_LOCATION, selection,
                        selectionArgs);
                break;
            case TODO_ID:
                String id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
                    rowsDeleted = sqlDB.delete(LocationsTable.TABLE_LOCATION,
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            case TODOS:
                rowsUpdated = sqlDB.update(LocationsTable.TABLE_LOCATION,
                        values,
                        selection,
                        selectionArgs);
                break;
    ...
    private void checkColumns(String[] projection) {
        String[] available = { LocationsTable.COLUMN_NAME,
                LocationsTable.COLUMN_REGION, LocationsTable.COLUMN_AREACODE,
